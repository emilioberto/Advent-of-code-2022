...
// const beaconOrSensors = new Set();
// const result = new Set();
// const y = 2_000_000;
//
// for (let x = minX; x <= maxX; x++) {
//     for (const element of data) {
//         if (element.beacon.x === x && element.beacon.y === y) {
//             beaconOrSensors.add(x);
//             break;
//         }
//         if (element.sensor.x === x && element.sensor.y === y) {
//             beaconOrSensors.add(x);
//             break;
//         }
//     }
...
//
// for (let x = minX; x < maxX; x++) {
//     if (beaconOrSensors.has(x)) {
//         continue;
//     }
//
//     for (const element of data) {
//         const closestBeaconDistance = Math.abs(element.beacon.x - element.sensor.x) + Math.abs(element.beacon.y - element.sensor.y);
//         const currentDistanceFromSensor = Math.abs(x - element.sensor.x) + Math.abs(y - element.sensor.y);
//         if (currentDistanceFromSensor <= closestBeaconDistance) {
//             result.add(x);
//             break;
//         }
//     }
